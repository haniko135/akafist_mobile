...
public class ItemSwipeCallback extends ItemTouchHelper.Callback {
    ...
    public ItemSwipeCallback(Context mContext) {
        this.mContext = mContext;
        this.backgroundColor = Color.parseColor("#b80f0a");
        this.mBackground = new ColorDrawable();
        this.mClearPaint = new Paint();
        this.mClearPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        this.deleteDrawable = ContextCompat.getDrawable(mContext, R.drawable.ic_baseline_delete_24);
    ...
    public interface ItemSwipeContract {
        ...
        void restoreItem(ServicesModel item, int position);
    }
